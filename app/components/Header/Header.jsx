...
// const Header = () => {
//   return (
//     <div className="bg-white text-black shadow-md justify-center items-center h-14">
//        <div className="flex justify-around">
//           <div>
//             <h1 className="text-4xl">S</h1>
//           </div>
//           <div className="flex gap-x-6 items-center justify-center text-xl">
...
//                 whileHover="hover"
//                 whileTap="tap"
//                 className="text-lg font-medium cursor-pointer text-gray-700 hover:text-blue-500 transition-colors"
//               >
//                 {item.name}
//               </motion.div>
//             ))}
...
//                   className="block py-2 text-lg font-medium text-gray-700 border-b border-gray-100"
//                 >
//                   {item.name}
//                 </motion.div>
//               ))}
...
//     hover: {
//       y: -2,
//       color: '#60a5fa', // Brighter blue for better dark mode visibility
//       transition: { duration: 0.2 }
//     },
//     tap: { scale: 0.95 }
//   };
...
const Header = () => {
  ...
  const mobileBottomNavItems = [
    ...
    { name: 'Map', id: 'map', icon: <FaMapMarkerAlt className="h-5 w-5" /> }
  ];
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {showReviewBtn && (
          <motion.div 
            className="md:hidden fixed bottom-20 left-0 right-0 flex justify-center z-40 px-4"
          ...
          >
            <motion.button
              onClick={() => scrolltoall('reviews')}
              className="w-1/2 bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-3 px-4 rounded-full shadow-lg flex items-center justify-center gap-2"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
...
//             <motion.button
//               whileTap={{ scale: 0.9 }}
//               className="hidden p-2 rounded-md text-gray-300 hover:text-white focus:outline-none"
//               onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
//             >
//               {isMobileMenuOpen ? (
//                 <FiX className="h-6 w-6" />
...
//       {/* Mobile Bottom Navigation (similar to the image) */}
...
// <motion.div 
//   className="fixed right-6 bottom-6 z-50"  // Adjust positioning as needed
//   initial={{ opacity: 0, y: 20 }}
//   animate={{ opacity: 1, y: 0 }}
...
//   <motion.button
//     onClick={() => scrolltoall('reviews')}
//     className="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-3 px-4 rounded-full shadow-lg flex items-center gap-2"
//     whileHover={{ scale: 1.05 }}
//     whileTap={{ scale: 0.95 }}
//   >
//     <FiStar className="text-lg" />
