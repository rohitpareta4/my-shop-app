...
//             We're here to help with all your electrical needs. Contact us for inquiries, emergencies, or service requests.
//           </p>
//         </div>
...
//           <div className="bg-gray-800 rounded-2xl shadow-xl p-8 border-l-4 border-blue-500">
...
//                   <p className="mt-1 text-gray-300">123 Main Road, Near Power House</p>
...
//                   <p className="mt-1 text-gray-300">+91 98765 43210 (General)</p>
//                   <p className="text-blue-400 font-medium">+91 98765 43211 (Emergency)</p>
//                 </div>
//               </div>
...
//                   <a href="mailto:electricalshop@example.com" className="mt-1 text-blue-400 hover:underline">
//                     electricalshop@example.com
//                   </a>
//                 </div>
//               </div>
...
//                   name="name"
//                   required
//                   className="mt-1 block w-full bg-gray-700 border border-gray-600 rounded-md py-3 px-4 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
...
//                   id="subject"
//                   name="subject"
//                   className="mt-1 block w-full bg-gray-700 border border-gray-600 rounded-md py-3 px-4 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
//                 >
...
//         {/* Map Section */}
//         <div className="mt-12 bg-gray-800 rounded-2xl shadow-xl overflow-hidden border-l-4 border-blue-500">
//           <h2 className="text-2xl font-bold text-white p-8 pb-0">Our Location</h2>
